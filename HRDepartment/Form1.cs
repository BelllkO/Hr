...
namespace HRDepartment
{
    public partial class Form1 : Form
    {
        ...
        private void AddDepItem_Click(object sender, EventArgs e)
        {
        ...
        private void DelDepItem_Click(object sender, EventArgs e)
        {
            ...
            if (result != "failed")
            {
                ...
                if(dep==null)
                {
                    MessageBox.Show("Не удалось найти департамент!", "Сообщение",
                                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
                else
                {
                    dep.Remove();
                    doc1.Save(path1);
                    MessageBox.Show("Департамент удален!", "Сообщение",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                    LoadDepartments();
                }
            }
        ...
        private void EditDepItem_Click(object sender, EventArgs e)
        {
        ...
        private void EmployeesList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //BirthField.Value = new DateTimeemp.Attribute("birth").Value;
